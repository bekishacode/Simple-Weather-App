  ...
  return (
    <div className='flex flex-col justify-center my-6'>
        <div className='flex flex-1 flex-row w-4/4 items-center justify-center space-x-4'>
            <input value={city} onChange={(e) => setCity(e.currentTarget.value)} type='text' placeholder='Search for city..' className='text-xl font-montserrat rounded-full  p-2 w-[400px] 
        ...
        <div className='flex flex-row w-1/4 items-center justify-center'>
            ...
            name='metric' className='text-xl text-white font-montserrat transition ease-out hover:scale-125'>°C</button>
            <p className='text-xl text-white mx-1'>|</p>
            <button onClick={handleUnitsChange} name='imperial' className='text-xl text-white font-montserrat transition ease-out hover:scale-125'>°F</button>
        </div>
    </div>
  )
}
